...
- How did the ratings/views change over the last few years?
 ...
 The data used in this exercise will be downloaded from Kaggle (https://www.kaggle.com/datasets/middlelight/goodreadsbookswithgenres). It includes information about genre, publisher, average review, etc.
